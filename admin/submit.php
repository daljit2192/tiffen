<?php 
	...
	if (isset($_POST['addmealplan']) && isset($_GET["mealid"]) && isset($_GET["id"])){
		...
		$mealid =  trim($_GET["mealid"]);
		$TargetPath=time().$filename;
		$mealplanData = array('name'=>$_POST["name"],'description'=>$_POST["description"],'image'=>$TargetPath,'mealid'=>$mealid);
	...
	if (isset($_POST['updatemealplan']) && isset($_GET["mealid"]) && isset($_GET["id"])){
		...
		$mealplanData = array('id'=>$id,'name'=>$_POST["name"],'description'=>$_POST["description"],'image'=>$TargetPath);
